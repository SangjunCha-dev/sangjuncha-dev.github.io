...
시퀀스의 시퀀스(리스트 또는 튜플)를 2차원 numpy 배열로 생성할 수 있다.
...
10진법의 숫자를 20이하 진법으로 변환한다.(2\<= n \<=20)
